...
// import Heroimg from 'https://webplentybackend.s3.ap-south-1.amazonaws.com/h.png'

export function Hero() {
  const slides = [
    {
      url: "https://webplentybackend.s3.ap-south-1.amazonaws.com/h.png",
    },
    // {
    //   url:
    //     "https://webplentybackend.s3.ap-south-1.amazonaws.com/ketaki-singh.jpg",
    // },
  ];
